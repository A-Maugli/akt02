...
def get_asset_index(default_index = 1010):
...
def main() :
    ...
    # gather the three default accounts and corresponding mnemonic passphrase
    ...
    index = get_asset_index(default_index = 1010) # ensure this matches the asset-index returned by asset_create.py
